...
class App extends React.Component {
	...
	componentDidMount() {
		...
		fetch(`http://workout.beynum.com/api/appload`, { credentials: "include" })
	...
	componentDidCatch(error, info) {
		fetch(`http://workout.beynum.com/api/errorsave`, { method: "post", headers: { "Content-Type": "application/json" }, credentials: "include", body: JSON.stringify({error: { error: error, info: info } }) });
	}
